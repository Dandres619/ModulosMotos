...
namespace ModulosTaller.Controllers
{
    public class ComprasController : Controller
    {
        ...
        {
            var tallerMotosDbContext = _context.Compras.Include(c => c.IdProveedorNavigation);
            return View(await tallerMotosDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCompra,FechaCompra,IdProveedor")] Compra compra)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCompra,FechaCompra,IdProveedor")] Compra compra)
        {
